...
and Performing summary statistics

It is designed to mimic essential operations of analytics libraries such as pandas and R data.frames, but built entirely from scratch using Java OOP principles.
